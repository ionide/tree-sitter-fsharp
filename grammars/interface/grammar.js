/**
 * @file FSharp interface grammar for tree-sitter
...
module.exports = grammar(require("../fsharp/grammar"), {
  name: "fsharp_interface",

  conflicts: ($) => [
    [$.argument_name_spec, $.long_identifier, $._identifier_or_op],
    [$.long_identifier, $._identifier_or_op],
    [$.long_identifier_or_op, $.simple_type],
  ...
  rules: {
    ...
    _module_signature_elements: ($, _original) =>
      choice($.value_signature, $.value_definition),
