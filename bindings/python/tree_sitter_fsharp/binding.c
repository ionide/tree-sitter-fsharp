...
static PyObject* _binding_language_signature(PyObject *Py_UNUSED(self), PyObject *Py_UNUSED(args)) {
    return PyCapsule_New(tree_sitter_fsharp_signature(), "tree_sitter.Language", NULL);
}
...
static PyMethodDef methods[] = {
    ...
    {"language_signature", _binding_language_signature, METH_NOARGS,
